...
var Utils = {
   ...
   getJSONPByPromise: function(url) {
    ...
    formValidation: function(form){
        ...
        //validation fails if the input is empty
        ...
        if(form.password1.value == "") {
            ...
            errors.push("Passwords don't match!");
             ...
             errors.push("You didn't add a username");
        }
        
        else if (!re_email.test(form.emailadress.value)){
            errors.push("You entered an invalid e-mailadress");
        }
